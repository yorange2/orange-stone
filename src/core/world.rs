...
use crate::core::component::{
    ...
    Dormant, DoubleDamageTaken, Durability, Elusive, Enchantment, Enrage, Freeze, HandTurnCounter,
    Health, HeroPowerDef, HeroPowerUsed, Immune, Lifesteal, LockedUntilCardPlayed, MegaWindfury,
