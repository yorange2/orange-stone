...
状态：里程碑 A–G 全部完成（PR #35–#62），里程碑 F 完成（PR #61、#63、#75：F1 过载锁定、F2 潜行、F4 保真审计、F5 差分验证含外部 SabberStone 对照）。F4 逐效果保真审计的 67 张积压卡已全部清偿（PR #79–#86，W0 接线 … W7 收尾），账本与路线图归档至 docs/finished/；F4/F5 持续审计机制保留——未来新增简化卡按归档账本的维护约定登记。
